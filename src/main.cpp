...
void showValues(DataSample<short> sample) {
    for (int i = 0; i < sample.getSize(); ++i) {
        std::cout << sample.getValues().get()[i] << " ";
    }
    std::cout << std::endl;
    std::cout << std::endl;
}
...
int main(int argc, char **argv) {
    ...
    auto wavHeader = WaveFileDataSource<short>::createPcmWavHeader(1, 44100, 16);

    WaveFileDataSource<short> newDt = WaveFileDataSource<short>(wavHeader, 20);

    WaveFileDataSource<short> dt = WaveFileDataSource<short>(
            "/home/szymon/Pobrane/sample/test_mono_44100Hz_16bit_PCM.wav", 20);

//    auto begin = dt.getSamplesIteratorBegin();
//    auto end = dt.getSamplesIteratorEnd();

//    FastFourierTransform<short> fft = FastFourierTransform<short>();
//
//    for(; begin != end; begin++) {
//        auto fftSample = fft.transform(*begin);
//        newDt.addSample(fft.reverseTransform(fftSample));
//    }

    auto begin = dt.getOffsetIteratorBegin(20, 0);
    auto end = dt.getOffsetIteratorEnd();

    for (; begin != end; ++begin) {
        //showValues(*begin);

        newDt.addSample(*begin);
    }
...
//    }
    ...
    newDt.saveToFile("/home/szymon/Pobrane/sample/offsetTest.wav");
    ...
    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_0.wav");
    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_1.wav");
    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_2.wav");
    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_3.wav");
    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_3_a.wav");
//    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_4.wav");
//    sourceFiles.push_back("/home/szymon/ClionProjects/speech-recognition/dataset/records/record_5.wav");
//    sourceFiles.push_back("/home/kacper/voice/samogloski.wav");

    std::string record0Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_0.txt");
    str_replace(record0Content, ",", "");

    std::string record1Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_1.txt");
    str_replace(record1Content, ",", "");

    std::string record2Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_2.txt");
    str_replace(record2Content, ",", "");

    std::string record3Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_3.txt");
    str_replace(record3Content, ",", "");

    std::string record4Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_4.txt");
    str_replace(record4Content, ",", "");

    std::string record5Content = getFileContent(
            "/home/szymon/ClionProjects/speech-recognition/dataset/variants/words_5.txt");
